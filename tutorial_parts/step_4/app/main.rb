...
def tick args
  ...
  if !args.state.click_count
   ...
   if args.state.click_count == 1
    ...
    args.outputs.sprites << [ 600, 500, 200, 200, 'mygame/sprites/circle-black.png', 45,    200,   10,    230,   15]
...
#-------------- Calculating the position
  ...
  if args.state.click_count == 3
    args.outputs.sprites << [screen_bound_x/2, screen_bound_y/2, sprite_size, sprite_size, 'mygame/sprites/circle-black.png',135]
  end
  ...
  if args.state.click_count == 4
    args.outputs.sprites << [ (screen_bound_x-sprite_size)/2, (screen_bound_y-sprite_size)/2, sprite_size, sprite_size, 'mygame/sprites/circle-black.png', 112.5]
  end
...
#---------- Movement
  ...
  if args.state.click_count == 5
    args.outputs.sprites << [ args.state.circle_x, args.state.circle_y,  sprite_size, sprite_size, 'mygame/sprites/circle-black.png', 90]
  ...
  if args.state.click_count >= 6 
    ...
    args.outputs.sprites << [ args.state.circle_x, args.state.circle_y,  sprite_size, sprite_size, 'mygame/sprites/circle-black.png', args.state.circle_direction]
    if args.inputs.keyboard.d && args.state.circle_x 
